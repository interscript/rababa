...
class TextEncoder:
    ...
    def __init__(
        ...
        self.input_symbol_to_id: dict[str, int] = {s: i for i, s in enumerate(self.input_symbols)}
        self.input_id_to_symbol: dict[int, str] = {i: s for i, s in enumerate(self.input_symbols)}

        self.target_symbol_to_id: dict[str, int] = {s: i for i, s in enumerate(self.target_symbols)}
        self.target_id_to_symbol: dict[int, str] = {i: s for i, s in enumerate(self.target_symbols)}
