"""Evaluate Hebrew v4 with standard DER calculation, fast (num_beams=1)."""
...
def evaluate_v3_fast(checkpoint: str = "/checkpoints/rababa_hebrew_byt5_v4/run-001/best") -> dict:
    ...
    print(f"=== Hebrew v4 DER (standard): {der:.4f} ({total_n} examples) ===", flush=True)
    return result
