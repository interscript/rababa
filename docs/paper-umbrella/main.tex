...
Common framework: ByT5~\cite{byt5} seq2seq (byte-level; tokenizer = UTF-8 bytes, so
...
evaluation harnesses, and \texttt{docs/RESULTS.md} ground truth; the
companion papers live in this repository's \texttt{docs/paper-*/}
trees (Arabic, Hebrew) alongside this synthesis.
