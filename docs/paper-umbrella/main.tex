...
state of the art in each. Results: Arabic \textbf{2.68\% DER} (CE) /
1.60\% (w/o CE) on the SadeedDiac-25 benchmark with Misraj's own
...
Gemini-Flash-2.0---and matching or beating our own verified GLM-5.2
frontier reproduction (2.69\%/1.72\% zero-skip; the published
Claude-3.7 figure of 1.39\% does not reproduce under a neutral
protocol)---plus a contamination audit showing the benchmark's public
source corpus leaks 122 of its own paragraphs, and a three-way RL
negative result (RAFT, sequence-GRPO, entropy-weighted GRPO) showing
the residual is knowledge-limited, not policy-limited; Hebrew 17.5\% DER
...
optima; policy optimization adds nothing at SFT convergence---every
verified gain came from data curation; and byte-level models are the
