...
\begin{enumerate}
  \item A compact char-level encoder (6 layers, $d=384$, 6 heads,
        ...
        a 580M ByT5-base~\cite{byt5} extends this to 2.81\% / 1.69\%,
...
\begin{itemize}
  ...
  \item \textbf{GTPO-GRPO} (entropy-weighted per-token
        credit~\cite{gtpo}; graded alignment-based reward): dev curve
...
\bibitem{byt5} Xue et al. ByT5: Towards a token-free future with pre-trained byte-to-byte models. TACL, 2022. arXiv:2105.13626.
\bibitem{muon} Liu et al. Muon is Scalable for LLM Training. arXiv:2502.16982, 2025.
